...
class SpiderDataset(Dataset):
    """ A torch.Dataset implementation of the Spider Text2SQL dataset"""
    def __init__(self, pkl_file: str):
        """Constructs an instance from a pickle of a pandas.DataFrame that 
           contains the columns 'instruction', 'output'"""
...
class SpiderSQLEnv(SQLEnv):
    ...
    def _calculate_rewards(self) -> Tensor:
        ...
        return tensor([
            ...
            for script in self.tokenizer.from_tokens(self.states)
        ], dtype=float)
